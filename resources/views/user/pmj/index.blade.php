                    ...
                    <table id="datatablesSimple" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td> --}}
                                        {{-- <form onsubmit="retrun confirm('apakah anda yakin?');" action="{{ route('peminjaman.destroy', $peminjaman->id)}}" method="POST" >
                                     <a href="{{ route('peminjaman.edit', $peminjaman->id)}}" class="btn btn-primary btn-sm ">Edit</a>
